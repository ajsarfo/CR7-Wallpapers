...
import com.sarftec.cristianoronaldo.domain.usecase.image.UploadImage
import com.sarftec.cristianoronaldo.domain.usecase.wallpaper.CreateWallpaper
...
class UploadViewModel @Inject constructor(
    ...
    private suspend fun createWallpaper(uploadInfo: UploadInfo): Resource<Unit> {
        val section = when (uploadInfo.section) {
            "Recent" -> CreateWallpaper.CreateSection.RECENT
            "Popular" -> CreateWallpaper.CreateSection.POPULAR
    ...
    class UploadInfo(val section: String, val category: String, val infoOverlay: UploadInfoOverlay)
