...
import com.sarftec.cristianoronaldo.databinding.LayoutUploadDialogBinding

class WallpaperProgressDialog(
    parent: ViewGroup,
    activity: Activity,
    ...
    private val layoutBinding = LayoutUploadDialogBinding.inflate(
